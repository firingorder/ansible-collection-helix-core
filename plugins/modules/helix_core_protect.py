...
short_description: This module will allow you to manage protection on Perforce Helix Core

description:
    - "Update Helix server protection"
...
seealso:
    - name: Helix Core protect
      description: "Update Helix server protects"
...
options:
    content:
        description:
            - The protect file content to add.
        required: true
        type: str
    server:
        description:
...
def run_module():
    ...
    try:
        p4.save_protect(module.params['content'])
        result['changed'] = True
