...
short_description: This module will allow you to manage typemaps on Perforce Helix Core

description:
    - "Update Helix server typemaps"
...
seealso:
    - name: Helix Core Typemap
      description: "Update Helix server typemaps"
...
options:
    content:
        description:
            - The typemap file content to add.
        required: true
        type: str
    server:
        description:
